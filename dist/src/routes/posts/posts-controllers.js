...
exports.SearchPostsAndUsers = exports.SearchPosts = exports.GetUserPostsBySlug = exports.CreateCommentByPostId = exports.GetCommentsByPostId = exports.GetPostById = exports.DeletePost = exports.CreatePost = exports.GetUserPosts = exports.GetPosts = void 0;
...
const SearchPostsAndUsers = async ({ query, page = 1, limit = 10, }) => {
    if (!query || query.trim() === "") {
        throw posts_types_1.SearchPostsError.QUERY_REQUIRED;
    }
    const skip = (page - 1) * limit;
    const [posts, users] = await Promise.all([
        prisma_1.prismaClient.post.findMany({
            where: {
                OR: [
        ...
        prisma_1.prismaClient.user.findMany({
            where: {
                OR: [
...
exports.SearchPostsAndUsers = SearchPostsAndUsers;
